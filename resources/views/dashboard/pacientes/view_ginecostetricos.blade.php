    ...
    <div class="card card-navy card-outline card-tabs">
        <div class="card-header p-0 pt-1 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist" xmlns:wire="http://www.w3.org/1999/xhtml">
                <li class="nav-item">
                    <a class="nav-link @if(/*$pa_label_pe*/true) active @endif" id="custom-tabs-three-home-tab"
                       data-toggle="pill" href="#tabs_datos_basicos" role="tab"
                       aria-controls="custom-tabs-three-home" aria-selected="@if(/*$pa_label_pe*/true) true @else false @endif">
                        Ginecostetricos
                    </a>
                </li>
                {{--<li class="nav-item">
        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-three-tabContent">
                <div class="tab-pane fade @if(/*$pa_label_pe*/true) active show @endif" id="tabs_datos_basicos" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">


                    <div class="row table-responsive p-0">
                        <form wire:submit.prevent="savePaciGine" xmlns:wire="http://www.w3.org/1999/xhtml">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                @foreach($pg_listar as $antecedente)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" wire:click="editPaciGine({{ $antecedente->id }})" class="btn btn-primary btn-sm"
                                                        {{--@if(!comprobarPermisos('paciante.edit')) disabled @endif--}} >
                                                    <i class="fas fa-edit"></i>
                                                </button>

                                                <button type="button" wire:click="destroyPaciGine({{ $antecedente->pg_id }})" class="btn btn-primary btn-sm"
                                                        @if(/*!comprobarPermisos('paciante.destroy') || */!$antecedente->pg_id) disabled @endif >
                                ...
                                @if($form_ginecostetricos)
                                    <tr class="table-primary">
                                        <th scope="row">{{ $form_ginecostetricos }}</th>
                                        {{--<td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" wire:model.defer="pg_detalles" placeholder="Detalles">
                                                    @error('pg_detalles')
